...
if(count($_POST)){
	...
	$sql="UPDATE `register` SET `name`='$name',`username`='$username',`phone`=$phone,`email`='$email',`password`='$password',`gender`='$gender',`School`='$school',`College`='$college',`bloodgrp`='$bloodgrp',`permanentAddress`='$permanentAddress',`localAddress`='$localAddress',`hometown`='$hometown' WHERE userId=$id";
	//print_r($sql);
...
<style>
.row.content{height:740px;!important}
...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav"><br><br><br>
      <p><a href="#" class="btn btn-success btn-block">DISPLAY</a></p><br>
    ...
    <h1 class="text-white text-center marleft">Update FORM</h1><br><br>
<form class="form-horizontal text-white" action="" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6"> 
      <input type="password" class="form-control" name="password" value="<?php echo $res['password']?>" id="pwd" placeholder="Enter password">
    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" name="school" value="<?php echo $res['School']?>" id="school">
    </div>
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" name="hometown" value="<?php echo $res['hometown']?>" id="hometown" placeholder="Enter Hometown">
    </div>
  </div>   

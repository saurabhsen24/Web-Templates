...
<div class="container-fluid text-center">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p><a href="display.php" class="btn btn-success btn-block">DISPLAY</a></p>
...
<form class="form-horizontal text-white" action="" method="post" onsubmit="return validateform()" name="myform">
